...
import { PlacementPrototype, usePrototypeVariant } from '@/components/placement-prototype';
...
export default function Home() {
  ...
  return (
    <main className="planner-shell">
      ...
      {prototypeVariant ? <PlacementPrototype room={state.room} variant={prototypeVariant} /> : <section id="workspace" className={`studio-grid ${placementDraft ? 'placement-active' : ''}`}>
